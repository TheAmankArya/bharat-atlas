...
// Mirrors Bharat's QuickStartGrid exactly — 4 tiles, scoped to what's genuinely
// functional in v1 (no "Today's Challenge"/"Random Question" yet, since those belong to
// the Coming Soon section until Daily Challenge is built).
const ITEMS = [
  ...
  { key: "explorer", emoji: "🗺️", label: "District Explorer", description: "Browse all 38 districts." },
  { key: "search", emoji: "🔍", label: "Search", description: "Jump straight to a place." },
];
