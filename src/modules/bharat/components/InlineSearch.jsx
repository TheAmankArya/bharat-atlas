...
import { search as searchLocations } from "../../../data/bharat";
  ...
  return (
    <section className="mx-auto w-full max-w-2xl px-6 py-8">
      ...
      <p className="mb-5 text-center text-sm text-ink-muted dark:text-white/50">
        Try &ldquo;Aravalli&rdquo;, &ldquo;Khardung La&rdquo;, &ldquo;Kaziranga&rdquo;, &ldquo;Chilika&rdquo;…
      </p>
      <div className="relative">
        ...
        <input
          ...
          placeholder="Search a mountain, river, pass, park, monument…"
